    ...
    <div class="row mt-3">
      <div class="col-md-12">
        <p class="text-muted">There is no data....<p>
          <a href="{{ route('vaccine.add') }}" class="btn btn-primary" role="button">Add Vaccine</a>
        </div>
    </div>
  </center>
</div>
      ...
      <table class="table table-primary">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$item->price}}</td>
              <td>
                <a href="{{ route('vaccine.edit',$item->id)}}" class="btn btn-warning" role="button">Edit</a>          
                <a href="{{ route('vaccine.delete',$item->id) }}" class="btn btn-danger" role="button">Delete</a>          
              </td>
            </tr>
              @endforeach
        </tbody>
